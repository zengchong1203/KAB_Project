$axure.internal(function($ax) {
    ...
    $ax.style.initTextAlignment = function(elementId, style) {
        ...
        if(_getObjVisible(textId)) {
            _setTextAlignment(textId, _idToAlignProps[textId], true);
        }
    };
    ...
    var _setTextAlignment = function(textId, alignProps, updateProps) {
        if(updateProps) {
            ...
            var paddingTop = style.paddingTop || 0;
            var paddingBottom = style.paddingBottom || 0;
            _idToAlignProps[textId] = alignProps = { vAlign: vAlign, paddingTop: paddingTop, paddingBottom: paddingBottom };
        }
